...
const MarkerOptions: FC = () => {
	const { answer, page } = useTypedSelector((state) => state)

	let center: LatLngExpression = [
		answer[page.value]?.requestH.latitude,
		answer[page.value]?.requestH.longitude,
	]
	...
	return (
		...
		>
			...
			/>
			<Circle center={center} fillColor="green" color="green" radius={1000} />
			<MarkerClusterGroup>
